// oxlint-disable
// Vendored from spotify-web-api-js, which the app no longer depends on — these
// are the shapes the whole codebase speaks, and only the declarations are kept.
// Left as it came, so a future update is a straight copy.
